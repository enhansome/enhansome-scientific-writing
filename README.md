...
* [Marktext](https://github.com/marktext/marktext) ⭐ 61,491 | 🐛 528 | 🌐 TypeScript | 📅 2026-09-16 - Markdown text editor.
* [R Studio](https://github.com/rstudio/rstudio) ⭐ 5,060 | 🐛 1,322 | 🌐 Java | 📅 2026-09-16 - IDE for R.
  * [bookdown](https://github.com/rstudio/bookdown) ⭐ 4,074 | 🐛 230 | 🌐 JavaScript | 📅 2026-08-28 - R package to facilitate writing books and long-form articles, reports with R Markdown :bookmark: :link:.
...
* [Visual Studio Code](https://code.visualstudio.com/) - Popular IDE with Markdown support.
  ...
  * [Markdown All in One](https://github.com/yzhang-gh/vscode-markdown/#readme) ⭐ 3,289 | 🐛 459 | 🌐 TypeScript | 📅 2026-06-13 - Extension for enhanced
...
* [citecheck](https://github.com/tobiasosDev/citecheck) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-30 - Command-line tool that matches BibTeX, RIS, and CSL-JSON references against Crossref and OpenAlex and flags retractions reported by Crossref.
...
* [Typst](https://github.com/typst/typst) ⭐ 56,050 | 🐛 1,297 | 🌐 Rust | 📅 2026-09-16 - Markup-based typesetting system with math, bibliography management, and fast incremental compilation to PDF.
...
* [pandoc](https://pandoc.org/MANUAL) - Haskell library for converting from
  ...
  * [Pandoc filters](https://github.com/jgm/pandoc/wiki/Pandoc-Filters) ⭐ 46,300 | 🐛 1,041 | 🌐 Haskell | 📅 2026-09-16 - List of
...
* [Vale](https://github.com/errata-ai/vale) ⭐ 6,109 | 🐛 30 | 🌐 Go | 📅 2026-09-10 - Free, open-source linter for
...
* [Markdown lint tool](https://github.com/markdownlint/markdownlint) ⭐ 2,075 | 🐛 109 | 🌐 Ruby | 📅 2026-09-07 - Markdown linter.
* [rumdl](https://github.com/rvben/rumdl) ⭐ 1,500 | 🐛 33 | 🌐 Rust | 📅 2026-09-14 - Fast Markdown linter and formatter written in Rust, with built-in support for several "flavors" such as GFM, MkDocs, MyST, Quarto etc.
...
* [Eisvogel](https://github.com/Wandmalfarbe/pandoc-latex-template) ⭐ 7,250 | 🐛 115 | 🌐 Shell | 📅 2026-07-04 - Clean academic pandoc LaTeX template.
...
* [Awesome Jupyter](https://github.com/markusschanta/awesome-jupyter/#renderingpublishingconversion) ⭐ 4,669 | 🐛 10 | 📅 2026-09-15
