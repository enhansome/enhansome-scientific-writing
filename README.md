# Awesome Scientific Writing with stars
...
* [Marktext](https://github.com/marktext/marktext) ⭐ 61,644 | 🐛 482 | 🌐 TypeScript | 📅 2026-09-20 - Markdown text editor.
* [R Studio](https://github.com/rstudio/rstudio) ⭐ 5,071 | 🐛 1,321 | 🌐 Java | 📅 2026-09-20 - IDE for R.
  * [bookdown](https://github.com/rstudio/bookdown) ⭐ 4,076 | 🐛 229 | 🌐 JavaScript | 📅 2026-09-18 - R package to facilitate writing books and long-form articles, reports with R Markdown :bookmark: :link:.
...
* [Vim](https://www.vim.org/) - Command line text editor.
  ...
  * [vim-pandoc-syntax](https://github.com/vim-pandoc/vim-pandoc-syntax) ⭐ 427 | 🐛 147 | 🌐 Vim Script | 📅 2025-09-22 - Pandoc syntax highlighting for Vim.
...
* [Visual Studio Code](https://code.visualstudio.com/) - Popular IDE with Markdown support.
  * [Markdown Preview Enhanced](https://github.com/shd101wyy/markdown-preview-enhanced) ⭐ 4,439 | 🐛 210 | 🌐 HTML | 📅 2026-05-05 - Pandoc
    integration and utilities.
  * [Markdown All in One](https://github.com/yzhang-gh/vscode-markdown/#readme) ⭐ 3,294 | 🐛 460 | 🌐 TypeScript | 📅 2026-06-13 - Extension for enhanced
...
* [citecheck](https://github.com/tobiasosDev/citecheck) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-30 - Command-line tool that matches BibTeX, RIS, and CSL-JSON references against Crossref and OpenAlex and flags retractions reported by Crossref.
* [ScholarRef](https://github.com/brodie-neuro/ScholarRef) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-03-10 - Convert citation styles
...
* [Zotero](https://www.zotero.org/) - FOSS tool to collect, organize, cite, and
  share research.
  * [Zotero OCR](https://github.com/UB-Mannheim/zotero-ocr) ⭐ 827 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-09 - Plugin that makes scanned PDFs searchable using Tesseract OCR and Poppler.
...
* [Typst](https://github.com/typst/typst) ⭐ 56,139 | 🐛 1,287 | 🌐 Rust | 📅 2026-09-18 - Markup-based typesetting system with math, bibliography management, and fast incremental compilation to PDF.
...
* [pandoc](https://pandoc.org/MANUAL) - Haskell library for converting from
  ...
  * [Pandoc filters](https://github.com/jgm/pandoc/wiki/Pandoc-Filters) ⭐ 46,347 | 🐛 1,039 | 🌐 Haskell | 📅 2026-09-20 - List of
...
* [Vale](https://github.com/errata-ai/vale) ⭐ 6,121 | 🐛 19 | 🌐 Go | 📅 2026-09-19 - Free, open-source linter for
  prose built with speed and extensibility in mind.
* [write-good](https://github.com/btford/write-good) ⭐ 5,089 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10 - Naive linter for English
  prose.
* [proselint](https://github.com/amperser/proselint) ⭐ 4,575 | 🐛 236 | 🌐 JavaScript | 📅 2026-09-04 - Linter for prose.
* [Markdown lint tool](https://github.com/markdownlint/markdownlint) ⭐ 2,077 | 🐛 108 | 🌐 Ruby | 📅 2026-09-19 - Markdown linter.
* [rumdl](https://github.com/rvben/rumdl) ⭐ 1,510 | 🐛 28 | 🌐 Rust | 📅 2026-09-20 - Fast Markdown linter and formatter written in Rust, with built-in support for several "flavors" such as GFM, MkDocs, MyST, Quarto etc.
* [remarklint](https://github.com/remarkjs/remark-lint) ⭐ 1,043 | 🐛 9 | 🌐 JavaScript | 📅 2026-01-05 - Markdown linter.
...
* [Eisvogel](https://github.com/Wandmalfarbe/pandoc-latex-template) ⭐ 7,256 | 🐛 115 | 🌐 Shell | 📅 2026-07-04 - Clean academic pandoc LaTeX template.
* [Template for writing a PhD thesis in
  Markdown](https://github.com/tompollard/phd_thesis_markdown#readme) ⭐ 1,272 | 🐛 42 | 🌐 HTML | 📅 2023-05-23 - Clean
...
* [Book on Riemann solvers](https://github.com/clawpack/riemann_book/#readme) ⭐ 295 | 🐛 15 | 🌐 HTML | 📅 2025-11-30 - This
...
* [Awesome Jupyter](https://github.com/markusschanta/awesome-jupyter/#renderingpublishingconversion) ⭐ 4,671 | 🐛 10 | 📅 2026-09-19
* [Awesome LaTeX](https://github.com/egeerardyn/awesome-LaTeX/#readme) ⭐ 1,669 | 🐛 6 | 📅 2026-08-08
* [Awesome Markdown](https://github.com/BubuAnabelas/awesome-markdown/#readme) ⭐ 957 | 🐛 73 | 📅 2024-08-21
